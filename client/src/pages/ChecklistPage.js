...
const SECS = [
  ...
  },
  {
    ...
    items: [
      ...
      { n: 'FM-06: საჩივრის/აპელაციის ფორმა — სრულია',                            c: 'BE-PR-10' },
      ...
      { n: 'FM-10: CAPA ფორმა — შევსებული და თვალყური ადევნებული',               c: 'BE-PR-13' },
      { n: 'FM-11: ინსპექტირების გეგმა — შევსებულია',                             c: 'BE-PR-09' },
      { n: 'FM-16: ვიზიტის ჩანაწერი — შევსებულია',                               c: 'BE-PR-04' },
      { n: 'FM-18: განაცხადის ფორმა — სრულია',                                    c: 'BE-PR-09' },
