...
const SECS = [
  ...
  },
  {
    ...
    items: [
      { n: 'FM-01: ინსპექტირების ანგარიშის შაბლონი — სრული და ვალიდური',          c: 'BE-PR-15' },
      { n: 'FM-02: მიუკერძოებლობის დეკლარაცია — ყველა პერსონალს ხელმოწერილი',    c: 'BE-PR-07' },
      { n: 'FM-03: კონფიდენციალობის შეთანხმება — ყველა პერსონალს ხელმოწერილი',   c: 'BE-PR-07' },
      { n: 'FM-04: შიდა აუდიტის გეგმა და ანგარიში — განახლებულია',               c: 'BE-PR-11' },
      { n: 'FM-05: მომსახურების ხელშეკრულება — შაბლონი სრულია',                   c: 'BE-PR-09' },
      { n: 'FM-06: საჩივრის და აპელაციის ფორმა — სრულია',                         c: 'BE-PR-10' },
      { n: 'FM-07: მოწყობილობის ვერიფიკაციის ფორმა — შევსებულია',                c: 'BE-PR-14' },
      { n: 'FM-08: კომპეტენციის შეფასების ფორმა — შევსებულია',                    c: 'BE-PR-08' },
      { n: 'FM-09: ხელშეკრულების განხილვის ფორმა — შევსებულია',                   c: 'BE-PR-09' },
      { n: 'FM-10: კორექტირებული ქმედების ჩანაწერი (CAPA) — შევსებული და თვალყური ადევნებული', c: 'BE-PR-13' },
      { n: 'FM-11: ინსპექტირების გეგმა — შევსებულია',                             c: 'BE-PR-09' },
      { n: 'FM-16: ვიზიტის ჩანაწერი — შევსებულია',                               c: 'BE-PR-04' },
      { n: 'FM-18: GAC-ის განაცხადის ფორმა — სრულია',                             c: 'BE-PR-09' },
  ...
  },
  {
    ...
    items: [
      ...
      { n: 'გარე ქვეკონტრაქტორების სია შედგენილია (FM-12, BE-PR-14)',             c: '§6.3' },
  ...
  },
  {
    ...
    items: [
      ...
      { n: 'მენეჯმენტის ანალიზის ოქმი (FM-15) — ბოლო შეხვედრის ოქმი შენახულია',  c: '§8.9' },
      { n: 'ცვლილების რეგისტრაცია (FM-24) — განახლებულია',                        c: '§8.3' },
