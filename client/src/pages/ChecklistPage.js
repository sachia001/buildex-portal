...
const SECS = [
  {
    ...
    items: [
      ...
      { n: 'QM-01 პერიოდული მიმოხილვა ჩატარებულია (მინ. წელიწადში ერთხელ)',       c: '§8.5' },
    ],
  },
  {
    ...
    items: [
      ...
      { n: 'ყველა პერსონალი გაცნობია პოლიტიკებს (BE-FM-FAMIL გაცნობის ფურცელი)',       c: '§6.1' },
    ],
  },
  {
    id: 'pr_core', title: '3. პროცედურები — ინსპექტირების ტექნიკური ციკლი (BE-PR-01–04, BE-PR-09, BE-PR-15)', period: 'quarterly', doc: 'B_პროცედურები',
    items: [
      { n: 'BE-PR-09: განაცხადის, ხელშეკრულების და სამუშაოს მიღების განხილვა — სრულია',         c: '§7.1' },
      { n: 'BE-PR-01: ხარჯთაღრიცხვის პროექტთან შესაბამისობის ინსპექტირება — სრულია',           c: '§7.4' },
      { n: 'BE-PR-02: შესრულებული სამუშაოებისა და ფორმა №2-ის ინსპექტირება — სრულია',          c: '§7.4' },
      { n: 'BE-PR-03: ხარჯთაღრიცხვის ფასწარმოქმნის ადეკვატურობის ინსპექტირება — სრულია',       c: '§7.4' },
      { n: 'BE-PR-04: ტექნიკური ზედამხედველობა–ინსპექტირება — სრულია',                          c: '§7.4' },
      { n: 'BE-PR-15: ინსპექტირების ანგარიშების, დასკვნებისა და სერტიფიკატების გაცემა — სრულია', c: '§7.6' },
      { n: 'BE-PR-MAIN: ინსპექტირების სრული პროცესის კონსოლიდირებული დოკუმენტი — სრულია',       c: '§7.1–7.6' },
    ],
  },
  {
    id: 'pr_qms', title: '4. პროცედურები — ხარისხის მართვის სისტემა (BE-PR-05–08, BE-PR-10–14)', period: 'quarterly', doc: 'B_პროცედურები',
    items: [
      { n: 'BE-PR-05: დოკუმენტებისა და გარე ნორმატიული დოკუმენტების მართვა — ვერსიების კონტროლი დანერგილია', c: '§8.3' },
      { n: 'BE-PR-06: ჩანაწერების, არქივისა და მონაცემთა დაცვის მართვა — შენახვის ვადები განსაზღვრულია',    c: '§8.4' },
      { n: 'BE-PR-07: მიუკერძოებლობისა და კონფიდენციალურობის უზრუნველყოფა — სრულია',                       c: '§4.1' },
      { n: 'BE-PR-08: პერსონალის კომპეტენცია, უფლებამოსილება და მონიტორინგი — სრულია',                     c: '§6.1' },
      { n: 'BE-PR-10: საჩივრებისა და აპელაციების მართვა — სრულია',                                          c: '§7.7' },
      { n: 'BE-PR-11: შიდა აუდიტი — გეგმა და კომპეტენტური შემმოწმებელი განსაზღვრული',                     c: '§8.6' },
      { n: 'BE-PR-12: მენეჯმენტის ანალიზი — დღის წესრიგი სრულია',                                          c: '§8.5' },
      { n: 'BE-PR-13: შეუსაბამობები, კორექცია და მაკორექტირებელი მოქმედებები (CAPA) — ფუძემდებლური ანალიზი ჩართული', c: '§8.8' },
      { n: 'BE-PR-14: აღჭურვილობის, გაზომვის საშუალებებისა და ქვეკონტრაქტირების მართვა — სრულია',          c: '§6.2' },
    ],
  },
  {
  ...
  {
    id: 'forms', title: '6. ფორმები და შაბლონები (BE-FM-REG–BE-FM-DESTROY-ACT)', period: 'monthly', doc: 'E_ფორმები_და_შაბლონები',
    items: [
      { n: 'BE-FM-REG: ინსპექტირების ანგარიშის შაბლონი — სრული და ვალიდური',          c: 'BE-PR-15' },
      { n: 'BE-FM-IMP-DECL: მიუკერძოებლობის დეკლარაცია — ყველა პერსონალს ხელმოწერილი',    c: 'BE-PR-07' },
      { n: 'BE-FM-CONF: კონფიდენციალობის შეთანხმება — ყველა პერსონალს ხელმოწერილი',   c: 'BE-PR-07' },
      { n: 'BE-FM-AUDIT-PLAN: შიდა აუდიტის გეგმა და ანგარიში — განახლებულია',               c: 'BE-PR-11' },
      { n: 'BE-FM-SCREEN: მომსახურების ხელშეკრულება — შაბლონი სრულია',                   c: 'BE-PR-09' },
      { n: 'BE-FM-COMPLAINT: საჩივრის და აპელაციის ფორმა — სრულია',                         c: 'BE-PR-10' },
      { n: 'BE-FM-EQ-CHECK: მოწყობილობის ვერიფიკაციის ფორმა — შევსებულია',                c: 'BE-PR-14' },
      { n: 'BE-FM-COMP-CHECK: კომპეტენციის შეფასების ფორმა — შევსებულია',                    c: 'BE-PR-08' },
      { n: 'BE-FM-CONTRACT-REVIEW: ხელშეკრულების განხილვის ფორმა — შევსებულია',                   c: 'BE-PR-09' },
      { n: 'BE-FM-CAPA: კორექტირებული ქმედების ჩანაწერი (CAPA) — შევსებული და თვალყური ადევნებული', c: 'BE-PR-13' },
      { n: 'BE-FM-PLAN: ინსპექტირების გეგმა — შევსებულია',                             c: 'BE-PR-09' },
      { n: 'BE-FM-VISIT: ვიზიტის ჩანაწერი — შევსებულია',                               c: 'BE-PR-04' },
      { n: 'BE-FM-APP: GAC-ის განაცხადის ფორმა — სრულია',                             c: 'BE-PR-09' },
      { n: 'BE-FM-INSP-REG: ინსპექტირების რეგისტრი — განახლებულია',                        c: '§7.3' },
    ],
  },
  {
    id: 'hr', title: '7. HR — სამუშაო აღწერილობები და კვალიფიკაცია', period: 'quarterly', doc: 'D_სამუშაო_აღწერილობები',
    items: [
      { n: 'HR-JD-001: სამუშაო აღწერილობა — დირექტორი — სრულია',                  c: '§6.1' },
      { n: 'HR-JD-002: სამუშაო აღწერილობა — ხარისხის მენეჯერი — სრულია',         c: '§6.1' },
      { n: 'HR-JD-003: სამუშაო აღწერილობა — ტექნიკური მენეჯერი — სრულია',        c: '§6.1' },
      { n: 'HR-JD-004: სამუშაო აღწერილობა — ინსპექტორი — სრულია',                c: '§6.1' },
      { n: 'HR-JD-005: სამუშაო აღწერილობა — ადმინისტრაციული მხარდაჭერა — სრულია', c: '§6.1' },
      ...
      { n: 'BE-FM-TRAIN ტრენინგის ჩანაწერი — შევსებულია და შენახულია',                 c: '§6.1' },
    ],
  },
  {
    id: 'tech', title: '8. ტექნიკური სფერო და მოწყობილობა', period: 'annual', doc: 'BE-PR-14',
    items: [
      { n: 'ინსპექტირების მეთოდების და სტანდარტების ნუსხა განახლებულია',          c: '§7.1' },
      { n: 'მოწყობილობების სრული სია — ინვენტარი შედგენილია (BE-PR-14)',          c: '§6.2' },
      { n: 'კალიბრაციის ვადები — ყველა მოწყობილობა 12 თვის ფარგლებშია',          c: '§6.2.3' },
      { n: 'BE-FM-EQ-CHECK მოწყობილობის ვერიფიკაციის ჩანაწერები — შევსებული',             c: '§6.2' },
      { n: 'გარე ქვეკონტრაქტორების სია შედგენილია (BE-FM-SUB-MONITOR, BE-PR-14)',             c: '§6.3' },
  ...
  },
  {
    ...
    items: [
      { n: 'BE-FM-IMP-DECL მიუკერძოებლობის დეკლარაცია — ყველა პერსონალს ხელმოწერილი',    c: '§4.1' },
      { n: 'კონფლიქტი ინტერესების რეესტრი — განახლებულია',                       c: '§4.1' },
      { n: 'კლიენტებთან კონფიდენციალობის შეთანხმება (BE-FM-CONF) — ხელმოწერილია',     c: '§4.2' },
  ...
  },
  {
    ...
    items: [
      ...
      { n: 'რისკების მართვა განხილულია მენეჯმენტის მიმოხილვაზე',                 c: '§8.5' },
    ],
  },
  {
    id: 'records', title: '11. მართვის ჩანაწერები და რეგისტრები', period: 'monthly', doc: 'BE-PR-06',
    items: [
      { n: 'შიდა აუდიტის განრიგი — შედგენილია (მინ. წელიწადში 2-ჯერ)',           c: '§8.6' },
      { n: 'ბოლო შიდა აუდიტის ანგარიში (BE-FM-AUDIT-PLAN) — შენახულია',                     c: '§8.6' },
      { n: 'ღია კორექტირებითი ქმედებების სტატუსი და ვადები — კონტროლდება',       c: '§8.8' },
      { n: 'მენეჯმენტის ანალიზის ოქმი (BE-FM-MGMT-REVIEW) — ბოლო შეხვედრის ოქმი შენახულია',  c: '§8.5' },
      { n: 'ცვლილების რეგისტრაცია (BE-FM-CHANGE-REG) — განახლებულია',                        c: '§8.3' },
      { n: 'კლიენტების საჩივრების რეესტრი — წარმოებული და განახლებული',          c: '§7.7' },
      { n: 'BE-FM-INSP-REG ინსპექტირების რეგისტრი — განახლებულია ყველა საქმით',           c: '§7.3' },
    ],
  },
];
