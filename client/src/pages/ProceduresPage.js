...
const ALL_DOCS_META = [
  ...
  { code: 'BE-FM-APP', category: 'form', title: 'განცხადების ფორმა', icon: '📝' },
  { code: 'BE-FM-REG', category: 'form', title: 'რეგისტრაციის ჟურნალი', icon: '📒' },
  { code: 'BE-FM-ACK', category: 'form', title: 'მიღების დადასტურება', icon: '✅' },
  { code: 'BE-FM-SCREEN', category: 'form', title: 'წინასწარი სკრინინგი', icon: '🔎' },
  ...
  { code: 'BE-FM-CONF', category: 'form', title: 'კონფიდენციალობის შეთანხმება', icon: '🤐' },
  { code: 'BE-FM-COMP', category: 'form', title: 'პერსონალის ავტორიზაცია', icon: '🎫' },
  { code: 'BE-FM-COMP-CHECK', category: 'form', title: 'კომპეტენციის ვერიფიკაცია', icon: '🎯' },
  ...
  { code: 'BE-FM-PLAN', category: 'form', title: 'ინსპექტირების გეგმა', icon: '🗺️' },
  { code: 'BE-FM-EQ-CHECK', category: 'form', title: 'აღჭურვილობის შემოწმება', icon: '🔩' },
  { code: 'BE-FM-EQ-CARD', category: 'form', title: 'აღჭურვილობის სარეგისტრაციო ბარათი', icon: '🗂️' },
  { code: 'BE-FM-VISIT', category: 'form', title: 'ვიზიტის ჩანაწერი', icon: '📍' },
  ...
  { code: 'BE-FM-PHOTO-LOG', category: 'form', title: 'ფოტო- და ვიდეოდოკუმენტაციის ჟურნალი', icon: '📷' },
  ...
  { code: 'BE-FM-IR', category: 'form', title: 'ინსპექტირების ანგარიში და დასკვნა', icon: '📋' },
  { code: 'BE-FM-TECH-REVIEW', category: 'form', title: 'ტექნიკური მიმოხილვა', icon: '✅' },
  ...
  { code: 'BE-FM-INSP-REG', category: 'form', title: 'ინსპექციების რეგისტრი', icon: '📚' },
  { code: 'BE-FM-COMPLAINT', category: 'form', title: 'საჩივრის რეგისტრაციის ფორმა', icon: '📣' },
  { code: 'BE-FM-APPEAL', category: 'form', title: 'აპელაციის რეგისტრაციის ფორმა', icon: '⚖️' },
  { code: 'BE-FM-NONCONF', category: 'form', title: 'შეუსაბამო სამუშაოს მართვა', icon: '🚫' },
  { code: 'BE-FM-CAPA', category: 'form', title: 'მაკორექტირებელი და პრევენციული ქმედება (CAPA)', icon: '🔄' },
  { code: 'BE-FM-CHANGE-INIT', category: 'form', title: 'ცვლილების ინიცირება', icon: '✍️' },
  ...
  { code: 'BE-FM-DESTROY-ACT', category: 'form', title: 'ლიკვიდაციის (განადგურების) აქტი', icon: '🗑️' },
  { code: 'BE-FM-AUDIT-PROGRAM', category: 'form', title: 'შიდა აუდიტის წლიური პროგრამა', icon: '📆' },
  { code: 'BE-FM-AUDIT-PLAN', category: 'form', title: 'შიდა აუდიტის გეგმა', icon: '📅' },
  { code: 'BE-FM-AUDIT-CHECK', category: 'form', title: 'შიდა აუდიტის ჩეკლისტი', icon: '☑️' },
  ...
  { code: 'BE-FM-SUB-MONITOR', category: 'form', title: 'ქვეკონტრაქტორის შეფასება და მონიტორინგი', icon: '🔗' },
  { code: 'BE-FM-SATISF', category: 'form', title: 'მომხმარებლის კმაყოფილების კვლევა', icon: '😊' },
  { code: 'BE-FM-MGMT-REVIEW', category: 'form', title: 'მართვის ანალიზი — სხდომის ოქმი', icon: '📈' },
  // F — პოლიტიკები
