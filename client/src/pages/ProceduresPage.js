...
const ALL_DOCS_META = [
  ...
  { code: 'BE-PR-02',    category: 'procedure',        title: 'შესრულებული სამუშაოებისა და ფორმა №2-ის ინსპექტირების სამუშაო პროცედურა',            icon: '🏗️' },
  { code: 'BE-PR-03',    category: 'procedure',        title: 'ხარჯთაღრიცხვის ფასწარმოქმნის ადეკვატურობის ინსპექტირების სამუშაო პროცედურა',        icon: '📊' },
  { code: 'BE-PR-04',    category: 'procedure',        title: 'ტექნიკური ზედამხედველობა–ინსპექტირების სამუშაო პროცედურა',                           icon: '👷' },
  { code: 'BE-PR-05',    category: 'procedure',        title: 'დოკუმენტებისა და გარე ნორმატიული დოკუმენტების მართვის პროცედურა',                    icon: '🗂️' },
  { code: 'BE-PR-06',    category: 'procedure',        title: 'ჩანაწერების, არქივისა და მონაცემთა დაცვის მართვის პროცედურა',                        icon: '📁' },
  { code: 'BE-PR-07',    category: 'procedure',        title: 'მიუკერძოებლობისა და კონფიდენციალურობის უზრუნველყოფის პროცედურა',                    icon: '⚖️' },
  { code: 'BE-PR-08',    category: 'procedure',        title: 'პერსონალის კომპეტენციის, უფლებამოსილების და მონიტორინგის პროცედურა',                 icon: '🎓' },
  { code: 'BE-PR-09',    category: 'procedure',        title: 'განაცხადის, ხელშეკრულების და სამუშაოს მიღების განხილვის პროცედურა',                  icon: '🤝' },
  ...
  { code: 'BE-PR-12',    category: 'procedure',        title: 'მენეჯმენტის ანალიზის პროცედურა',                                                      icon: '📈' },
  ...
  { code: 'FM-10',       category: 'form',             title: 'კორექტირებული ქმედების ჩანაწერი (CAPA)',                                               icon: '🔄' },
  ...
  { code: 'FM-18',       category: 'form',             title: 'GAC-ის განაცხადის ფორმა',                                                             icon: '🏛️' },
