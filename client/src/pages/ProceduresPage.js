...
const ALL_DOCS_META = [
  ...
  { code: 'BE-PR-01', category: 'procedure', title: 'ობიექტის ხარჯთაღრიცხვის ინსპექტირება', icon: '💰' },
  { code: 'BE-PR-02', category: 'procedure', title: 'ობიექტზე შესრულებული სამუშაოების ინსპექტირება (მათ შორის ფორმა №2-ის მიხედვით)', icon: '🏗️' },
  { code: 'BE-PR-03', category: 'procedure', title: 'ობიექტის ხარჯთაღრიცხვის ფასწარმოქმნის ადეკვატურობის ინსპექტირება', icon: '📊' },
  { code: 'BE-PR-04', category: 'procedure', title: 'დოკუმენტების მართვის პროცედურა', icon: '🗂️' },
  { code: 'BE-PR-05', category: 'procedure', title: 'ჩანაწერების, არქივისა და მონაცემთა დაცვის მართვის პროცედურა', icon: '📁' },
  { code: 'BE-PR-06', category: 'procedure', title: 'მიუკერძოებლობისა და კონფიდენციალურობის უზრუნველყოფის პროცედურა', icon: '⚖️' },
  { code: 'BE-PR-07', category: 'procedure', title: 'პერსონალის კომპეტენციის მართვის, უფლებამოსილების და მონიტორინგის პროცედურა', icon: '🎓' },
  { code: 'BE-PR-08', category: 'procedure', title: 'განაცხადის მიღების, ხელშეკრულების განხილვისა და ინსპექტირების სამუშაოს მიღების პროცედურა', icon: '🤝' },
  { code: 'BE-PR-09', category: 'procedure', title: 'საჩივრებისა და აპელაციების განხილვის პროცედურა', icon: '📣' },
  { code: 'BE-PR-10', category: 'procedure', title: 'შიდა აუდიტის პროცედურა', icon: '🔎' },
  { code: 'BE-PR-11', category: 'procedure', title: 'მენეჯმენტის ანალიზის პროცედურა', icon: '📈' },
  { code: 'BE-PR-12', category: 'procedure', title: 'შეუსაბამობების, კორექციული და პრევენციული ქმედებების მართვის პროცედურა (CAPA)', icon: '🔄' },
  { code: 'BE-PR-13', category: 'procedure', title: 'აღჭურვილობის და გაზომვის საშუალებების მართვის პროცედურა', icon: '🔩' },
  { code: 'BE-PR-14', category: 'procedure', title: 'ქვეკონტრაქტირების მართვის პროცედურა', icon: '🔗' },
  { code: 'BE-PR-15', category: 'procedure', title: 'ანგარიშგების, დოკუმენტირებისა და გაცემის პროცედურა', icon: '📋' },
  { code: 'BE-PR-16', category: 'procedure', title: 'აკრედიტაციის კომბინირებული სიმბოლოს გამოყენების პროცედურა', icon: '🏅' },
  // C — სამუშაო ინსტრუქციები
  { code: 'BE-WI-01', category: 'instruction', title: 'ხარჯთაღრიცხვის შესაბამისობის შემოწმება', icon: '📐' },
  { code: 'BE-WI-02', category: 'instruction', title: 'შესრულებული სამუშაოს ფორმა', icon: '🏗️' },
  ...
  { code: 'HR-JD-003', category: 'job_description', title: 'სამუშაო აღწერილობა — ტექნიკური მენეჯერი', icon: '⚙️' },
  ...
  // E — ფორმები და შაბლონები (BE-FM-რეესტრი — 60 ფორმა)
  { code: 'BE-FM-APP', category: 'form', title: 'განცხადება', icon: '📝' },
  { code: 'BE-FM-REG', category: 'form', title: 'მოთხოვნის რეგისტრაცია', icon: '📒' },
  { code: 'BE-FM-ACK', category: 'form', title: 'მიღების დადასტურება', icon: '✅' },
  { code: 'BE-FM-SCREEN', category: 'form', title: 'განცხადების განხილვა და სამუშაოს მიღება', icon: '🔎' },
  { code: 'BE-FM-IMP-DECL', category: 'form', title: 'მიუკერძოებლობის დეკლარაცია', icon: '⚖️' },
  { code: 'BE-FM-IMP-GEN', category: 'form', title: 'მიუკერძოებლობის ზოგადი დეკლარაცია', icon: '📜' },
  { code: 'BE-FM-IMP-CHECK', category: 'form', title: 'მიუკერძოებლობის შემოწმება', icon: '🔍' },
  { code: 'BE-FM-IMP-RISK', category: 'form', title: 'მიუკერძოებლობის რისკების შეფასება', icon: '⚠️' },
  { code: 'BE-FM-IMP-COMMITTEE', category: 'form', title: 'მიუკერძოებლობის დაცვის კომიტეტის ოქმი', icon: '🏛️' },
  { code: 'BE-FM-CONF', category: 'form', title: 'კონფიდენციალურობის შეთანხმება', icon: '🤐' },
  { code: 'BE-FM-COMP', category: 'form', title: 'პერსონალის ავტორიზაცია', icon: '🎫' },
  { code: 'BE-FM-COMP-CHECK', category: 'form', title: 'კომპეტენციის შეფასება', icon: '🎯' },
  { code: 'BE-FM-TRAIN', category: 'form', title: 'ტრენინგის ჩანაწერი', icon: '📚' },
  { code: 'BE-FM-EST', category: 'form', title: 'ბიუჯეტის შეფასება', icon: '💰' },
  { code: 'BE-FM-OFFER', category: 'form', title: 'კომერციული შეთავაზება', icon: '💼' },
  { code: 'BE-FM-CONTRACT-REVIEW', category: 'form', title: 'ხელშეკრულების განხილვა', icon: '📝' },
  { code: 'BE-FM-CONTRACT', category: 'form', title: 'ხელშეკრულების შაბლონი', icon: '📄' },
  { code: 'BE-FM-CONTRACT-REGISTRY', category: 'form', title: 'ხელშეკრულებების რეესტრი', icon: '📒' },
  { code: 'BE-FM-DECLINE', category: 'form', title: 'უარის წერილი', icon: '✉️' },
  { code: 'BE-FM-DOC-REQ', category: 'form', title: 'დოკუმენტაციის მოთხოვნა', icon: '📨' },
  { code: 'BE-FM-DOC-CHECK', category: 'form', title: 'საკმარისობის შემოწმება', icon: '☑️' },
  { code: 'BE-FM-NORM-PROFILE', category: 'form', title: 'ობიექტის ნორმატიული პროფილი', icon: '🧭' },
  { code: 'BE-FM-ORD', category: 'form', title: 'ჯგუფის დანიშვნის ბრძანება', icon: '📌' },
  { code: 'BE-FM-NOTIFY', category: 'form', title: 'ცნობის ფურცელი', icon: '🔔' },
  { code: 'BE-FM-PLAN', category: 'form', title: 'ინსპექციის გეგმა', icon: '🗺️' },
  { code: 'BE-FM-EQ-CHECK', category: 'form', title: 'მოწყობილობის ვერიფიკაცია', icon: '🔩' },
  { code: 'BE-FM-EQ-CARD', category: 'form', title: 'აღჭურვილობის სარეგისტრაციო ბარათი', icon: '🗂️' },
  { code: 'BE-FM-VISIT', category: 'form', title: 'ვიზიტის ჩანაწერები', icon: '📍' },
  { code: 'BE-FM-FIELD-LOG', category: 'form', title: 'საველე ჟურნალი', icon: '📓' },
  { code: 'BE-FM-MEASURE', category: 'form', title: 'გაზომვების ფორმა', icon: '📏' },
  { code: 'BE-FM-OBSERVATION', category: 'form', title: 'დაკვირვების ფორმა', icon: '👁️' },
  { code: 'BE-FM-PHOTO-LOG', category: 'form', title: 'ფოტოდოკუმენტაციის ჟურნალი', icon: '📷' },
  { code: 'BE-FM-COMPARE', category: 'form', title: 'შედარების ცხრილი', icon: '📊' },
  { code: 'BE-FM-CALC', category: 'form', title: 'გამოთვლები', icon: '🧮' },
  { code: 'BE-FM-NORM-CHECK', category: 'form', title: 'ნორმატიული შესაბამისობა', icon: '📐' },
  { code: 'BE-FM-FINDING', category: 'form', title: 'მიგნებების ცხრილი', icon: '🔖' },
  { code: 'BE-FM-IR', category: 'form', title: 'ინსპექტირების ანგარიში', icon: '📋' },
  { code: 'BE-FM-TECH-REVIEW', category: 'form', title: 'ანგარიშის ტექნიკური გადამოწმება', icon: '✅' },
  { code: 'BE-FM-QM-CHECK', category: 'form', title: 'ხარისხის შემოწმება', icon: '🛡️' },
  { code: 'BE-FM-DELIVERY-LETTER', category: 'form', title: 'გადაცემის წერილი', icon: '✉️' },
  { code: 'BE-FM-ACCEPT-ACT', category: 'form', title: 'მიღება-ჩაბარების აქტი', icon: '🤝' },
  { code: 'BE-FM-IR-REGISTRY', category: 'form', title: 'დასკვნების რეესტრი', icon: '📒' },
  { code: 'BE-FM-INSP-REG', category: 'form', title: 'ინსპექციების რეესტრი (ჟურნალი)', icon: '📚' },
  { code: 'BE-FM-COMPLAINT', category: 'form', title: 'საჩივარი და აპელაცია', icon: '📣' },
  { code: 'BE-FM-APPEAL', category: 'form', title: 'აპელაციის რეგისტრაციის ფორმა', icon: '⚖️' },
  { code: 'BE-FM-NONCONF', category: 'form', title: 'შეუსაბამო სამუშაოების მართვა', icon: '🚫' },
  { code: 'BE-FM-CAPA', category: 'form', title: 'მაკორექტირებელი ქმედებები', icon: '🔄' },
  { code: 'BE-FM-CHANGE-INIT', category: 'form', title: 'დოკუმენტის ცვლილებების წინადადება', icon: '✍️' },
  { code: 'BE-FM-CHANGE-REG', category: 'form', title: 'ცვლილებების რეგისტრი', icon: '📒' },
  { code: 'BE-FM-FAMIL', category: 'form', title: 'გაცნობის ფურცელი', icon: '👁️' },
  { code: 'BE-FM-DESTROY-ACT', category: 'form', title: 'ლიკვიდაციის აქტი', icon: '🗑️' },
  { code: 'BE-FM-AUDIT-PROGRAM', category: 'form', title: 'შიდა აუდიტის პროგრამა (წლიური გეგმა)', icon: '📆' },
  { code: 'BE-FM-AUDIT-PLAN', category: 'form', title: 'შიდა აუდიტის გეგმა', icon: '📅' },
  { code: 'BE-FM-AUDIT-CHECK', category: 'form', title: 'აუდიტის ჩეკლისტი', icon: '☑️' },
  { code: 'BE-FM-AUDIT-REPORT', category: 'form', title: 'შიდა აუდიტის ანგარიში', icon: '📋' },
  { code: 'BE-FM-AUDIT-NC', category: 'form', title: 'აუდიტის შეუსაბამობის ფორმა', icon: '⛔' },
  { code: 'BE-FM-AUDIT-MEETING', category: 'form', title: 'აუდიტის შეხვედრის ოქმი', icon: '🤝' },
  { code: 'BE-FM-SUB-MONITOR', category: 'form', title: 'ქვეკონტრაქტორის შეფასება', icon: '🔗' },
  { code: 'BE-FM-SATISF', category: 'form', title: 'მომხმარებლის კმაყოფილების კვლევა', icon: '😊' },
  { code: 'BE-FM-MGMT-REVIEW', category: 'form', title: 'მართვის ანალიზი', icon: '📈' },
  // F — პოლიტიკები
  { code: 'BE-POL-01', category: 'policy', title: 'მიუკერძოებლობის პოლიტიკა', icon: '⚖️' },
  { code: 'BE-POL-02', category: 'policy', title: 'კონფიდენციალურობის პოლიტიკა', icon: '🔒' },
  { code: 'BE-POL-03', category: 'policy', title: 'ხარისხის პოლიტიკა', icon: '✅' },
  { code: 'BE-POL-04', category: 'policy', title: 'IT და მონაცემთა უსაფრთხოების პოლიტიკა', icon: '💻' },
  // G — რისკების მართვა
  ...
  { code: 'ORD-03B', category: 'order', title: 'ბრძანება — ინსპექტორების დანიშვნა (დანართი)', icon: '📌' },
