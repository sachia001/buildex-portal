...
export const FORM_CONFIGS = {
  ...
  'BE-FM-COMPLAINT': {
    ...
    sections: [
      { label: 'მომართვის მონაცემები', fields: [
        ...
        { id: 'contactForm',     label: 'კონტაქტის ფორმა',              type: 'select', options: ['ფიზიკური წერილი','ელექტრონული ფოსტა','ვიდეო-გზავნილი','ტელეფონი'] },
    ...
    sections: [
      ...
      { label: '1b. დაუყოვნებელი ქმედება + §3 გადაუდებელი შეჩერება', fields: [
        ...
        { id: 'suspensionActions', label: 'გადაუდებელი შეჩერება (§3)', type: 'multicheck',
          options: ['კლიენტი — სამუშაო შეჩერება','ობიექტი — კორექცია','სხვა საქმეების გადახედვა','კლიენტთან გარკვევა საჭირო არ არის'] },
      ]},
  ...
  'BE-FM-VISIT': {
    ...
    sections: [
      { label: 'საიდენტიფიკაციო მონაცემები', fields: [
        ...
        { id: 'visitTime',     label: 'დაწყება – დასრულება',              type: 'text', placeholder: 'მაგალითად: 10:00 – 14:00' },
        { id: 'address',       label: 'ობიექტის მისამართი',               type: 'text' },
        { id: 'inspector',     label: 'ინსპექტორი',                       type: 'staffmulti' },
      ...
      { label: 'D. დეფექტები (5 ჩანაწერი)', fields: [
        ...
        { id: 'd1_page',     label: 'D1. სტანდარტის გვერდი',            type: 'text' },
        ...
        { id: 'd2_page',     label: 'D2. სტანდარტის გვერდი',            type: 'text' },
        ...
        { id: 'd3_page',     label: 'D3. სტანდარტის გვერდი',            type: 'text' },
        ...
        { id: 'd4_page',     label: 'D4. სტანდარტის გვერდი',            type: 'text' },
        ...
        { id: 'd5_page',     label: 'D5. სტანდარტის გვერდი',            type: 'text' },
  ...
  'BE-FM-APP': {
    ...
    sections: [
      { label: 'განმცხადებლის მონაცემები', fields: [
        ...
        { id: 'rep',    label: 'წარმომადგენელი (სახელი/გვარი)',     type: 'text' },
  ...
  'BE-FM-SATISF': {
    ...
    sections: [
      ...
      { label: 'C. დამატებითი კითხვები', fields: [
        ...
        { id: 'avgScore',         label: 'საშუალო ქულა (გამოთვლა)',                  type: 'text', placeholder: 'მაგალითად: 4.5' },
      ...
      { label: 'B. გასანადგურებელი დოკუმენტების სია', fields: [
        { id: 'docList', label: 'დოკუმენტების სია', type: 'tablerows', minRows: 3,
          columns: [
            ...
            { id: 'expiry',  label: 'შენახვის ვადა (თვე)',        md: 2 },
            { id: 'copies',  label: 'ასლების რაოდენობა',               md: 2 },
  ...
  'BE-FM-AUDIT-PROGRAM': {
    ...
    sections: [
      ...
      { label: 'პროგრამის მონაცემები', fields: [
        ...
        { id: 'completedVsPlanned',  label: 'შესრულებული / გეგმური (რაოდენობა)',    type: 'text' },
  ...
  'BE-FM-REG': {
    ...
    sections: [
      { label: 'წარდგენილი დოკუმენტაცია', fields: [
        { id: 'submittedDocs', label: 'წარდგენილი დოკუმენტაცია (მონიშნე)', type: 'multicheck', options: ['საპროექტო დოკუმენტაცია','ხარჯთაღრიცხვა','ტექნიკური დავალება','სახელშეკრულებო დოკუმენტაცია','ნახაზები / სქემები','ნებართვა / ლიცენზია','სხვა'] },
      ]},
      { label: 'A. საქმის საიდენტიფიკაციო მონაცემები', fields: [
        ...
        { id: 'receiptMethod', label: 'მიღების ფორმა',             type: 'select', options: ['ელექტრონული ფოსტა', 'ფოსტა', 'პირადად', 'ტელეფონი'] },
      ...
      { label: 'B. დამკვეთის მონაცემები', fields: [
        ...
        { id: 'clientPhone',    label: 'ტელეფონი',               type: 'text' },
        { id: 'clientEmail',    label: 'ელექტრონული ფოსტა',              type: 'text' },
        { id: 'clientAddress',  label: 'მისამართი',               type: 'text' },
        { id: 'representative', label: 'წარმ.',              type: 'text' },
      ]},
      { label: 'C. ობიექტი', fields: [
        { id: 'objectName',    label: 'ობიექტის დასახელება',              type: 'text' },
        { id: 'objectAddress', label: 'ობიექტის მისამართი',            type: 'text' },
        { id: 'objectCategory',label: 'ობიექტის კატეგორია',            type: 'text' },
        { id: 'contractNum',   label: 'ხელშეკრულების №',             type: 'text' },
        { id: 'description',   label: 'აღწერა',                type: 'textarea' },
      ]},
      { label: 'D. წარდგენილი დოკუმენტაცია', fields: [
        { id: 'docsProject',  label: 'საპროექტო დოკუმენტაცია',              type: 'yesno' },
        { id: 'docsBudget',   label: 'ხარჯთაღრიცხვა',                 type: 'yesno' },
        { id: 'docsTD',       label: 'ტექნიკური დავალება',             type: 'yesno' },
        { id: 'docsContract', label: 'სახელშეკრულებო დოკუმენტაცია',             type: 'yesno' },
        { id: 'docsDrawings', label: 'ნახაზები / სქემები',          type: 'yesno' },
        { id: 'otherDocs',    label: 'სხვა',                type: 'textarea' },
      ]},
      { label: 'E. წინასწარი შეფასება (ტექნიკური მენეჯერი)', fields: [
        { id: 'completenessCheck',  label: 'დოკუმენტაციის სისრულე დადასტურდა',    type: 'yesno' },
        ...
        { id: 'tmNote',             label: 'შენიშვნა / მოთხოვნები',    type: 'textarea' },
      ]},
    ],
  },
  ...
  'BE-FM-SCREEN': {
    ...
    sections: [
      ...
      { label: 'C. შესაძლებლობების დადასტურება', fields: [
        { id: 'staffAvailable', label: 'პერსონალი ხელმისაწვდომია',   type: 'yesno' },
        { id: 'equipAvailable', label: 'აღჭურვილობა ხელმისაწვდომია',   type: 'yesno' },
        { id: 'timeAvailable',  label: 'ვადა რეალური',   type: 'yesno' },
      ]},
      { label: 'D–E. შეზღუდვები / გადაწყვეტილება', fields: [
        { id: 'scopeLimitations', label: 'შეზღუდვები / შენიშვნა',          type: 'textarea' },
        { id: 'decision',         label: 'გადაწყვეტილება', type: 'select', options: ['accept', 'reject', 'defer'] },
        { id: 'decisionDate',     label: 'გადაწყვეტილების თარიღი',              type: 'date' },
        { id: 'decisionNote',     label: 'გადაწყვეტილების დასაბუთება',            type: 'textarea' },
      ]},
    ],
  },
  ...
  'BE-FM-IMP-RISK': {
    ...
    sections: [
      { label: 'A. ზოგადი ინფორმაცია', fields: [
        { id: 'assessmentId',   label: 'შეფასების №',       type: 'text' },
        { id: 'assessmentDate', label: 'თარიღი',         type: 'date' },
        { id: 'caseId',         label: 'BE-CASE №',    type: 'text' },
        { id: 'inspector',      label: 'ინსპ.',         type: 'staffmulti' },
        { id: 'clientName',     label: 'დამკ.',         type: 'text' },
        { id: 'objectName',     label: 'ობიექტი',           type: 'text' },
      ]},
      { label: 'C. გადაწყვეტილება', fields: [
        { id: 'overallRiskLevel', label: 'საერთო რისკის დონე', type: 'select', options: ['acceptable', 'review', 'mitigate'] },
        { id: 'controlMeasures', label: 'კონტროლის ზომები / შემცირების ღონისძიებები',  type: 'textarea' },
        { id: 'decision',        label: 'გადაწყვეტილება',            type: 'select', options: ['accept', 'restricted', 'rejected'] },
      ]},
    ],
  },
  ...
  'BE-FM-EQ-CARD': {
    ...
    sections: [
      { label: 'A. აღჭურვილობის საიდენტიფიკაცია', fields: [
        ...
        { id: 'status',       label: 'სტატუსი',              type: 'select', options: ['Active', 'Calibrating', 'Suspended', 'Decommissioned'] },
        { id: 'name',         label: 'დასახ.',           type: 'text' },
        { id: 'model',        label: 'მოდელი',             type: 'text' },
  ...
  'BE-FM-SUB-MONITOR': {
    ...
    sections: [
      ...
      { label: 'B. კვალიფიკაციის შეფასების ცხრილი (6 კრიტერიუმი)', fields: [
        ...
        { id: 'totalScore', label: 'ჯამური ქულა (0–6)',          type: 'text' },
        { id: 'decision',   label: 'გადაწყვეტილება', type: 'select', options: ['approved', 'conditional', 'rejected'] },
      ]},
    ],
  },
