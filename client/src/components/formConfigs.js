  ...
  'BE-FM-TECH-REVIEW': {
    ...
    sections: [
      { label: 'საიდენტიფიკაციო მონაცემები', fields: [
        ...
        { id: 'verifier',          label: 'ვერიფიკატორი (ტექ. მენეჯერი)',       type: 'staffmulti' },
        { id: 'inspector',         label: 'ინსპექტორი',                         type: 'staffmulti' },
        { id: 'inspScope',         label: 'ინსპექციის სფერო',                   type: 'select', options: ['BE-PR-01','BE-PR-02','BE-PR-03','BE-PR-04','სხვა'] },
      ]},
  ...
  'BE-FM-REG': {
    ...
    sections: [
      { label: 'წარდგენილი დოკუმენტაცია', fields: [
        { id: 'submittedDocs', label: 'წარდგენილი დოკ. (მონიშნე)', type: 'multicheck', options: ['საპროექტო დოკუმენტაცია','ხარჯთაღრიცხვა','ტექნიკური დავალება','სახელშეკრულებო დოკ.','ნახაზები / სქემები','ნებართვა / ლიცენზია','სხვა'] },
      ]},
