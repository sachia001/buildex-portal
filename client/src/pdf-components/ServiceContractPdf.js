...
const SCOPE_DATA = {
  'BE-PR-01': {
    title: 'ხარჯთაღრიცხვის საპროექტო დოკუმენტებთან შესაბამისობის ინსპექტირება',
    procedure: 'BE-PR-01',
    isoRef: 'ISO §8.1',
    art11suffix: 'ხარჯთაღრიცხვის საპროექტო/ტექნიკურ დოკუმენტებთან შესაბამისობის ინსპექტირება',
    art13: 'მომსახურება ხორციელდება BE-PR-01 სამუშაო პროცედურის შესაბამისად და მოიცავს: ხარჯთაღრიცხვის ყველა პოზიციის, საზომი ერთეულების (კვ.მ, გრ.მ, ტ), რაოდენობებისა და ტექნიკური დახასიათებების შედარებას დამტკიცებულ პროექტთან, ნახაზებთან, სპეციფიკაციებთან და ტექნიკურ დავალებასთან; გამოტოვებული, გადამეტებული ან დუბლირებული პოზიციების გამოვლენას; ორმხრივი მიკვლევადობის (პროექტი→ხარჯთაღრიცხვა/ხარჯთაღრიცხვა→პროექტი) დამყარებას. ინსპექტირება კამერალური (დოკუმენტური) ანალიზის სახისაა; საჭიროებისამებრ — საველე გადამოწმება. ფასების საბაზრო ადეკვატურობის შეფასება ამ ხელშეკრულებით არ ფარავს (იხ. BE-PR-03).',
    art2_3: 'ინსპექტირების ანგარიში გამოიცემა ინსპექტირების ჩატარებიდან 5 (ხუთი) სამუშაო დღის ვადაში, თუ მხარეებს სხვაგვარად არ შეუთანხმდებიათ.',
    art2_2: 'ინსპექტირების კონკრეტული განხორციელების ვადა შეთანხმდება მხარეებს შორის ხელშეკრულების ხელმოწერიდან 3 (სამი) სამუშაო დღის ვადაში.',
  },
  'BE-PR-02': {
    title: 'შესრულებული სამუშაოებისა და ფორმა №2-ის ინსპექტირება',
    procedure: 'BE-PR-02',
    isoRef: 'ISO §8.3',
    art11suffix: 'ფაქტობრივად შესრულებული სამუშაოებისა და ფორმა №2 (KS-2)-ის ვერიფიკაცია',
    art13: 'მომსახურება ხორციელდება BE-PR-02 სამუშაო პროცედურის შესაბამისად და მოიცავს: ადგილზე საველე ინსპექტირებას ფიზიკური გაზომვებით, ფოტოფიქსაციითა და ხარისხობრივი შეფასებით; ფორმა №2 (KS-2) და ფორმა №3 (KS-3)-ში ასახული მოცულობებისა და ღირებულებების კამერალურ ვერიფიკაციას; ხელმისაწვდომი ფარული სამუშაოების (კედელში ჩაშვებული მილები, ამოვსებული ფუნდამენტი) შემოწმებას ჩაბარება-მიღების აქტებზე დაყრდნობით; გამოყენებული მასალების ხარისხის ვიზუალურ შეფასებას. ხარჯთაღრიცხვის ფასების ადეკვატურობის შეფასება ამ ხელშეკრულებით არ ფარავს (იხ. BE-PR-03).',
    art2_3: 'ინსპექტირების ანგარიში გამოიცემა ინსპექტირების ჩატარებიდან 5 (ხუთი) სამუშაო დღის ვადაში, თუ მხარეებს სხვაგვარად არ შეუთანხმდებიათ.',
    art2_2: 'ინსპექტირების კონკრეტული თარიღი (ან თარიღები) შეთანხმდება მხარეებს შორის ხელშეკრულების ხელმოწერიდან 3 (სამი) სამუშაო დღის ვადაში.',
  },
  'BE-PR-03': {
    title: 'ხარჯთაღრიცხვის ფასწარმოქმნის ადეკვატურობის ინსპექტირება',
    procedure: 'BE-PR-03',
    isoRef: 'ISO §8.1',
    art11suffix: 'ხარჯთაღრიცხვის ფასწარმოქმნის ადეკვატურობის ინსპექტირება',
    art13: 'მომსახურება ხორციელდება BE-PR-03 სამუშაო პროცედურის შესაბამისად და მოიცავს: ხარჯთაღრიცხვაში გამოყენებული ერთეული ფასების, ნორმატიული ბაზის (СНиП/ЕНиР), დარიცხული კოეფიციენტებისა და ზედნადები ხარჯების კამერალურ ვერიფიკაციას; ფასების შედარებას ბაზრის კომერციულ შეთავაზებებთან, საქართველოს მშენებელთა კავშირის კვარტალურ ფასებთან და სხვა სარეფერენსო წყაროებთან; ლოკაციის, მიწოდების პირობის, სეზონური ეფექტისა და სხვა ფასგანმსაზღვრელი ფაქტორების გათვალისწინებას. ფიზიკური მოცულობების ადგილზე გაზომვა ამ ხელშეკრულებით არ ფარავს (იხ. BE-PR-02).',
    art2_3: 'ინსპექტირების ანგარიში გამოიცემა ანალიზის დასრულებიდან 5 (ხუთი) სამუშაო დღის ვადაში, თუ მხარეებს სხვაგვარად არ შეუთანხმდებიათ.',
    art2_2: 'ანალიზისათვის საჭირო ყველა დოკუმენტის წარდგენიდან 3 (სამი) სამუშაო დღის ვადაში შემსრულებელი დაიწყებს ინსპექტირებას.',
  },
  'BE-PR-04': {
    title: 'სამშენებლო სამუშაოთა ტექნიკური ზედამხედველობა–ინსპექტირება',
    procedure: 'BE-PR-04',
    isoRef: 'ISO §7.2',
    art11suffix: 'სამშენებლო სამუშაოთა ტექნიკური ზედამხედველობა–ინსპექტირება',
    art13: 'მომსახურება ხორციელდება BE-PR-04 სამუშაო პროცედურის შესაბამისად და მოიცავს: ობიექტზე პერიოდულ საველე ვიზიტებს (დაგეგმილი და სპონტანური); სამუშაოთა შესრულების ტექნოლოგიის, გამოყენებული მასალების ხარისხისა და საკონტროლო ეტაპების ვიზუალურ და ინსტრუმენტულ შემოწმებას; ფარული სამუშაოების კონტროლს დაფარვამდე; სამუშაოთა ჟურნალის, ფარული სამუშაოების აქტებისა და მასალების სერტიფიკატების დოკუმენტურ კონტროლს; შენიშვნების ჟურნალის წარმოებასა და პერიოდულ ანგარიშებს. ეს არ არის ერთჯერადი შეფასება — ეს დროში განაწილებული, გაგრძელებადი მონიტორინგია.',
    art2_3: 'თითოეული ვიზიტის შემდეგ ინსპექტორი ადგენს ვიზიტის ოქმს. შუალედური/საბოლოო ანგარიში გამოიცემა ხელშეკრულებით განსაზღვრული ეტაპების დასრულების ან ზედამხედველობის პერიოდის ამოწურვისთანავე.',
    art2_2: 'ვიზიტების სიხშირე და განრიგი შეთანხმდება მხარეებს შორის ხელშეკრულების ხელმოწერიდან 3 (სამი) სამუშაო დღის ვადაში — საწყის ზედამხედველობის გეგმაში.',
  },
};
...
const ServiceContractPdf = ({ data = {} }) => {
  ...
  const scope = SCOPE_DATA[serviceType] || SCOPE_DATA['BE-PR-01'];
    ...
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          <Text style={s.centerSub}>{scopeTitle}</Text>
          <Text style={s.centerRef}>{`${scope.procedure}  |  ${scope.isoRef}  |  საქართველოს სამოქალაქო კოდექსი  |  „ინსპექტირების საქმიანობის შესახებ" საქართველოს კანონი`}</Text>
          {contractNumber
          ...
          <Text style={s.para}>{`1.1. წინამდებარე ხელშეკრულების საფუძველზე შემსრულებელი — შპს „ბილდექს ექსპერტიზა" (ISO/IEC 17020:2012/2013-ის შესაბამისად აკრედიტებული A ტიპის ინსპექტირების ორგანო) — ვალდებულია გაუწიოს დამკვეთს ${scope.art11suffix}-ის მომსახურება (პროცედურა ${scope.procedure}), ხოლო დამკვეთი ვალდებულია მიიღოს ეს მომსახურება და გადაიხადოს ხელშეკრულებით განსაზღვრული საფასური.`}</Text>
          <Text style={s.para}>{`1.2. ინსპექტირების ობიექტი: ${objectAddress}.`}</Text>
          <Text style={s.para}>{`1.3. ${scope.art13}`}</Text>
          {serviceScope
            ? <Text style={s.para}>{`1.4. დამატებითი სამუშაოს მოცულობა / განსაკუთრებული პირობები: ${serviceScope}.`}</Text>
            : null}
          <Text style={s.para}>{`${serviceScope ? '1.5' : '1.4'}. შემსრულებელი ახორციელებს ინსპექტირებას ISO/IEC 17020:2012/2013 სტანდარტის, ${scope.procedure} სამუშაო პროცედურის, საქართველოს კანონმდებლობისა და დარგობრივი ნორმების სრული დაცვით.`}</Text>
          ...
          <Text style={s.para}>{`2.2. ${scope.art2_2}`}</Text>
          <Text style={s.para}>{`2.3. ${scope.art2_3}`}</Text>
