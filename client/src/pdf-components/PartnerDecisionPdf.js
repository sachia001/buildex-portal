        ...
        <View style={s.body}>
          ...
          {isSingle ? (
            <Text style={s.preamble}>
              {`მე, ${p0.name} (საქართველოს მოქალაქე, პირადი ნომერი: ${p0.personalId}, რეგისტრირებული მისამართი: საქართველო, ${p0.address || '—'}), როგორც შეზღუდული პასუხისმგებლობის საზოგადოება „ბილდექს ექსპერტიზა"-ს ${p0.share || 100}%-იანი წილის ერთპიროვნულმა პარტნიორმა, „მეწარმეთა შესახებ" საქართველოს კანონისა და საქართველოს სამოქალაქო კოდექსის შესაბამისად, მივიღე შემდეგი\n\nგ ა დ ა წ ყ ვ ე ტ ი ლ ე ბ ა :`}
            </Text>
          ) : (
            <Text style={s.preamble}>
