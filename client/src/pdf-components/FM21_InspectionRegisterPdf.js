  ...
  <Document>
    <Page size="A4" orientation="landscape" style={[s.page,{paddingHorizontal:28}]}>
      ...
      <Text style={{fontSize:7,color:'#555',marginBottom:5}}>
        სახეობა: PR-01=ხიდი/გზა | PR-02=ფუნდამენტი | PR-03=ფასადი/ასაწყობი | PR-04=ზარდახში/ინფრასტრუქტურა | სტატუსი: R=რეგისტრირებული | A=მიმდინარე | C=დასრულებული | S=შეჩერებული
      </Text>
