...
const FM29_AuditNCFormPdf = ({ data = {} }) => {
  ...
  <Document>
    <Page size="A4" style={[s.page, { paddingTop: 12, paddingBottom: 22, paddingHorizontal: 28 }]}>
      <WM />
      <FormHeader code="BE-FM-29" isoRef="სსტ ISO/IEC 17020 §8.6/§8.7" title="აუდიტის შეუსაბამობის ფორმა" subtitle="Audit Non-Conformity Form" />

      <Text style={s.secH}>A. შეუსაბამობის საიდენტიფიკაციო მონაცემები</Text>
      <FieldRow2 label1="FM-26 აუდიტის №:" value1={data.auditNumber} label2="NC №:" value2={data.ncNumber} />
      ...
      <FieldRow2 label1="FM-10 CAPA №:" value1={data.capaNumber} label2="ვადა:" value2={data.deadline} />
      ...
      <FormFooter code="BE-FM-29 v2.0 | 28.04.2026 | ISO §8.6/8.7 | შენახვა: 5 წელი" />
    </Page>
  </Document>
);};
